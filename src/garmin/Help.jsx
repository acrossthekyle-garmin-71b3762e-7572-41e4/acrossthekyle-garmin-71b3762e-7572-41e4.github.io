...
const Help = () => {
    ...
    <>
      <p className="lead text-start">
        If you have any issues with entering, or receiving, an Unlock Code please
        reach out to me via email at <a href="mailto:acrossthekyle@gmail.com">acrossthekyle@gmail.com</a>, or
        through the "Contact Developer" feature in the ConnectIQ mobile app.
      </p>
